...
<div id="container-A">   
     ...
     <h2> Stage en développement informatique </h2>

    <p> • Niveau : Bac+3 à Bac+5 <br />
• Lieu : Technopark, Casablanca <br />
• Durée : 3 mois (renouvelable)<br />
• Missions : développement logiciel, cloud/cybersécurité, data science <br />
...
<div id="container-B">   
    ...
    <h2> Stage en Marketing et Communication</h2>
    <p> Missions : gestion des réseaux sociaux, création de contenu, relations prospects, organisation d’événements.<br />
